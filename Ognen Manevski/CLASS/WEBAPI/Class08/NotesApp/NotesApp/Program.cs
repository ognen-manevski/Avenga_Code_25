...
//builder.Services.AddScoped<INoteRepository, NoteRepositoryAdoNet>(); // Use ADO.NET implementation
builder.Services.AddScoped<INoteRepository, NoteRepositoryDapper>(); // Use Dapper implementation
