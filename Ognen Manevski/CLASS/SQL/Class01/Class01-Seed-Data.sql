...
delete from dbo.OrderDetails where 1=1; --1=1 is a common way to write a condition that is always true, effectively deleting all records from the table
										--is it necessary to write where 1=1?
										--No, we can simply write "delete from dbo.OrderDetails" to achieve the same result.
										--The "where 1=1" is redundant in this context.
